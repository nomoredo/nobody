        ...
        loop {
            ...
            for (index, option) in options.iter().enumerate() {
                if index == selected_index {
                    ...
                    showln!(yellow_bold,"│",yellowbg,format!("\x1b[30m {} ", option.get_title()),white," ", yellow, option.get_description());
                } else {
                    ...
                    showln!(white,"│",white,format!(" {} ", option.get_title()),white," ", gray, option.get_description());
                }
