...
class FutureGenerator extends GeneratorForAnnotation<NomoCode> {
  ...
  FutureOr<String> generateForAnnotatedElement(
    ...
    buffer.writeln('''/// CODE GENERATED BY NOMOCODE 
    /// DO NOT EDIT''');
    buffer.writeln();
    //import original file
    buffer.writeln("/// IMPORTING ORIGINAL SOURCE");
    buffer.writeln(
        "import 'package:${buildStep.inputId.package}/references.dart';");
    //extension
    ...
    for (var method in classElement.methods) {
      if (method.isOperator ||
          method.isAbstract ||
          //if method is not async
          !method.returnType.toString().contains('Future')) {
        continue;
      }
